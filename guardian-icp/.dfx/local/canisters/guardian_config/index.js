...
import { idlFactory } from './guardian_config.did.js';
export { idlFactory } from './guardian_config.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_GUARDIAN_CONFIG;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./guardian_config.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the guardian_config canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./guardian_config.did.js")._SERVICE>}
 */
export const guardian_config = createActor(canisterId);
